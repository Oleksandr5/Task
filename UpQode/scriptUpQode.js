...
// For height block with text section Our Products

function windowSizeTitle () {
    var heightTitle = $('.imgTitle').height();
    $('.text-my').height(heightTitle);
}

$(window).on('load resize', windowSizeTitle);
 ...
 const slider = [
    ...
    function createSlider(sliderValue) {
        ...
        <div class="row text-center justify-content-center text-slider">
          <div class="col-12">
            <h2>${sliderValue.h2}</h2>
          </div>
          <div class="w-100"></div>
          <div class="col-6 p-sl">
            <p>${sliderValue.p}</p>
          </div>
        </div>
        </div>
...
// Array WHY CHOOSE US
 ...
 const yourTitle = [
        { src: 'img/yourTitle1.png', h4: 'Your Title', p: 'Duis bibendum diam non erat facilaisis en ter tincidunt. Duis '},
        { src: 'img/yourTitle2.png', h4: 'Your Title', p: 'Duis bibendum diam non erat facilaisis en ter tincidunt. Duis '},
        { src: 'img/yourTitle3.png', h4: 'Your Title', p: 'Duis bibendum diam non erat facilaisis en ter tincidunt. Duis '},
        { src: 'img/yourTitle4.png', h4: 'Your Title', p: 'Duis bibendum diam non erat facilaisis en ter tincidunt. Duis '},
        { src: 'img/yourTitle5.png', h4: 'Your Title', p: 'Duis bibendum diam non erat facilaisis en ter tincidunt. Duis '}
    ]
    function createTitle(title) {
        ...
        <div class="col-6 col-sm-4 col-lg-2 p-0">
          <div class="card">
            <div class="img-title">
            <img src="${title.src}" alt="" class="card-img-top">
            </div>
...
function windowCardHover () {
    var heightCard = $('.card-my').height();
    $('.card-hover').height(heightCard*1.2);
}

$(window).on('load resize', windowCardHover);
 ...
 const productsValue1 = [
    ...
    function createProducts1(product1) {
        ...
        <div class="col-4 p-0">
          ...
          <div class="media">
            <img class="media-left imgTitle" alt="Image" src="${product1.src}">
    ...
    function createProducts2(product2) {
        ...
        <div class="col-4 p-0">
          ...
          <div class="media">
            <img class="media-left imgTitle" alt="Image" src="${product2.src}">
            <div class="media-body pl-3 text-my">
              <h4>${product2.h4}</h4>
              <h5>${product2.h5}</h5>
              <p>${product2.p}</p>
    ...
    function createProducts3(product3) {
        ...
        <div class="col-4 p-0">
          ...
          <div class="media">
            <img class="media-left imgTitle" alt="Image" src="${product3.src}">
            <div class="media-body pl-3 text-my">
              <h4>${product3.h4}</h4>
              <h5>${product3.h5}</h5>
              <p>${product3.p}</p>
